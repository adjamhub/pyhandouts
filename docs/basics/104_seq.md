...
Facciamo un altro esempio con valori eterogenei:
    ...
    # scrive: ( "ciao" , 12 , *23.45 *, 1000000 , 12, "come??" )
...
tupla ("pippo", "ciccio", "pippo", "ciccio", "pippo", "ciccio").
...
Esempio: metodo sort()
    ...
    lettere.sort()
    print(lettere)
    # scrive [ 'a' , 'c' , 'o' , 's' ] # ordinate secondo l'ordine alfabetico
...
banali... fortunatamente l'utilizzo del metodo copy() è abbastanza raro in
Python :)
