...
```python title="if elemento in sequenza"
...
```python title="for elemento in sequenza: scorre gli elementi"
parola = "oggi"
for car in parola:
    print(car)
```
...
```python title="for pos in range(len(sequenza)): scorre le posizioni"
    parola = "oggi"
