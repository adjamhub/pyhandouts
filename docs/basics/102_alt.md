...
scelte perché vale il seguente ***teorema (Jacopini-Bohm, 1966)***
...
sorgente. I linguaggi più famosi, come C o Java, utilizzano le parentesi
...
Anche qui, pur avendo le parole chiave then -- else - ; che racchiudono
...
forma di organizzazione del codice in blocchi! In questo modo le parole
del linguaggio da imparare sono pochissime e la struttura del linguaggio
...
Esempio di codice in linguaggio Python
...
Poiché però scrivere ogni volta 4, 8, 12 oppure 16 spazi risulta una
vera scocciatura, gli editor di testo più avanzati per la programmazione
(quindi... non il blocco note di Windows!!!) trasformano automaticamente
ogni TAB in 4 spazi semplici!
...
(suggerimento: se sapete verificare se un numero è multiplo di un altro,
...
Chiedere all'utente di inserire un numero intero. Visualizzare poi il
numero stesso e la cifra delle decine. Ad esempio se il numero inserito
è 243, la cifra da visualizzare è 4. Se il numero inserito è 85, la
cifra da visualizzare è 8. Se il numero inserito è 1357, la cifra da
visualizzare è 5.
