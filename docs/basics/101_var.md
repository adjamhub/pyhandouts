...
**in Python il risultato della divisione è sempre un numero reale, un `float`**.
...
!!! warning "Attenzione!"
    ...
    Il risultato di una divisione intera è un intero (e fino a qui...) che va calcolato
    arrotondando per troncamento e mai per eccesso!!!
...
| str()    | Trasforma il suo argomento in una stringa. <br> Funziona sempre :)                                                                                                        |
