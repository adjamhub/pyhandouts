...
A dire la verità, grazie alle f-strings in Python è facilissimo anche *formattare* numeri e stringhe secondo necessità. Provo ad elencare le 
possibilità più conosciute in una tabella:
...
print(f"{massima} in binario è {massima:b}")
...
print(f"percentuale {value:%}")
```

Che scrivono rispettivamente
