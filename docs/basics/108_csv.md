...
``` py title="Esempio 2: salvataggio su file dei dati presenti in una lista di dizionari"
import csv
...
file = open("esempio.csv", "w", newline="") # il parametro newline così impostato assicura che il codice funzioni uguale su Win,Mac,Linux
