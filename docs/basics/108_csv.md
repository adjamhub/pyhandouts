...
Ovviamente, se l'elemento non è presente si scriva ZERO (Suggerimento: usate la funzione...).

Chiedere all'utente di selezionare un altro prodotto e stavolta, se il prodotto è presente, togliere quel prodotto dal magazzino, 
visualizzando anche il numero di pezzi che vengono scaricati (Suggerimento: usate la funzione...).
