...
### Istruzione import (TODO)

In Python la clausola import si utilizza per rendere 
...
Faccio alcuni esempi in una tabella con il nome corretto del modulo e una descrizione sommaria. Elenco i moduli più comuni:
